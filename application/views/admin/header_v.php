...
<head>
    ...
    <title>Tripseru dashboard admin</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Tripseru.com</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="/atur/admin"><i class="fa fa-dashboard fa-fw"></i> Dashboard </a>
                        </li>                        
                        <li>
                            <a href="/atur/destinasi"><i class="fa fa-edit fa-fw"></i> Destinasi<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/atur/destinasi/all">All Destinasi</a>
                                </li>
                                <li>
                                    <a href="/atur/destinasi">Add New Destinasi</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> Trip Order<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                            	<li>
